...
const categories = [
  {
    ...
    icon: <Pizza size={32} color="#FFFFFF" strokeWidth={2.5} />,
    icon: <Pizza size={24} color="#FFFFFF" strokeWidth={2.5} />,
    image: 'https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg?auto=compress&cs=tinysrgb&w=400',
    gradient: ['#FA4616', '#FF6B35'],
    popular: true,
  },
  {
    id: 'coffee',
    ...
    icon: <Coffee size={32} color="#FFFFFF" strokeWidth={2.5} />,
    icon: <Coffee size={24} color="#FFFFFF" strokeWidth={2.5} />,
    image: 'https://images.pexels.com/photos/302899/pexels-photo-302899.jpeg?auto=compress&cs=tinysrgb&w=400',
    gradient: ['#8B4513', '#FA4616'],
    popular: true,
  },
  {
    id: 'grocery',
    ...
    icon: <ShoppingCart size={32} color="#FFFFFF" strokeWidth={2.5} />,
    icon: <ShoppingCart size={24} color="#FFFFFF" strokeWidth={2.5} />,
    image: 'https://images.pexels.com/photos/264636/pexels-photo-264636.jpeg?auto=compress&cs=tinysrgb&w=400',
    gradient: ['#0021A5', '#4ECDC4'],
  },
  {
    id: 'car',
    title: 'Ride Share',
    subtitle: 'Campus transportation',
    icon: <Car size={32} color="#FFFFFF" strokeWidth={2.5} />,
    icon: <Car size={24} color="#FFFFFF" strokeWidth={2.5} />,
    image: 'https://images.pexels.com/photos/116675/pexels-photo-116675.jpeg?auto=compress&cs=tinysrgb&w=400',
    gradient: ['#0021A5', '#667eea'],
  },
  {
    id: 'workout',
    title: 'Workout Partner',
    subtitle: 'Gym & fitness buddy',
    icon: <Dumbbell size={32} color="#FFFFFF" strokeWidth={2.5} />,
    icon: <Dumbbell size={24} color="#FFFFFF" strokeWidth={2.5} />,
    image: 'https://images.pexels.com/photos/1552242/pexels-photo-1552242.jpeg?auto=compress&cs=tinysrgb&w=400',
    gradient: ['#FA4616', '#FF9A9E'],
  },
  {
    id: 'study',
    title: 'Study Partner',
    subtitle: 'Academic collaboration',
    icon: <BookOpen size={32} color="#FFFFFF" strokeWidth={2.5} />,
    icon: <BookOpen size={24} color="#FFFFFF" strokeWidth={2.5} />,
    image: 'https://images.pexels.com/photos/159711/books-bookstore-book-reading-159711.jpeg?auto=compress&cs=tinysrgb&w=400',
    gradient: ['#0021A5', '#A8EDEA'],
  },
  {
    id: 'package',
    title: 'Package Pickup',
    subtitle: 'Mail & deliveries',
    icon: <Package size={32} color="#FFFFFF" strokeWidth={2.5} />,
    icon: <Package size={24} color="#FFFFFF" strokeWidth={2.5} />,
    image: 'https://images.pexels.com/photos/4246120/pexels-photo-4246120.jpeg?auto=compress&cs=tinysrgb&w=400',
    gradient: ['#FA4616', '#FFA726'],
  },
  {
    id: 'tutoring',
    title: 'Tutoring',
    subtitle: 'Academic help',
    icon: <GraduationCap size={32} color="#FFFFFF" strokeWidth={2.5} />,
    icon: <GraduationCap size={24} color="#FFFFFF" strokeWidth={2.5} />,
    image: 'https://images.pexels.com/photos/5212345/pexels-photo-5212345.jpeg?auto=compress&cs=tinysrgb&w=400',
    gradient: ['#0021A5', '#8B5CF6'],
  },
  {
    id: 'gaming',
    title: 'Gaming Partner',
    subtitle: 'Play together',
    icon: <Gamepad2 size={32} color="#FFFFFF" strokeWidth={2.5} />,
    icon: <Gamepad2 size={24} color="#FFFFFF" strokeWidth={2.5} />,
    image: 'https://images.pexels.com/photos/442576/pexels-photo-442576.jpeg?auto=compress&cs=tinysrgb&w=400',
    gradient: ['#8B5CF6', '#FA4616'],
  },
  {
    id: 'music',
    title: 'Music Events',
    subtitle: 'Concerts & shows',
    icon: <Music size={32} color="#FFFFFF" strokeWidth={2.5} />,
    icon: <Music size={24} color="#FFFFFF" strokeWidth={2.5} />,
    image: 'https://images.pexels.com/photos/1105666/pexels-photo-1105666.jpeg?auto=compress&cs=tinysrgb&w=400',
    gradient: ['#FA4616', '#FFD700'],
  },
  {
    id: 'photography',
    title: 'Photography',
    subtitle: 'Photo sessions',
    icon: <Camera size={32} color="#FFFFFF" strokeWidth={2.5} />,
    icon: <Camera size={24} color="#FFFFFF" strokeWidth={2.5} />,
    image: 'https://images.pexels.com/photos/90946/pexels-photo-90946.jpeg?auto=compress&cs=tinysrgb&w=400',
    gradient: ['#0021A5', '#10B981'],
  },
  {
    id: 'repair',
    title: 'Tech Repair',
    subtitle: 'Device fixes',
    icon: <Wrench size={32} color="#FFFFFF" strokeWidth={2.5} />,
    icon: <Wrench size={24} color="#FFFFFF" strokeWidth={2.5} />,
    image: 'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&cs=tinysrgb&w=400',
    gradient: ['#10B981', '#0021A5'],
  },
  {
    id: 'laundry',
    title: 'Laundry Help',
    subtitle: 'Washing & folding',
    icon: <Heart size={32} color="#FFFFFF" strokeWidth={2.5} />,
    icon: <Heart size={24} color="#FFFFFF" strokeWidth={2.5} />,
    image: 'https://images.pexels.com/photos/963486/pexels-photo-963486.jpeg?auto=compress&cs=tinysrgb&w=400',
    gradient: ['#FA4616', '#8B5CF6'],
  },
  {
    id: 'cleaning',
    title: 'Room Cleaning',
    subtitle: 'Tidy up spaces',
    icon: <Briefcase size={32} color="#FFFFFF" strokeWidth={2.5} />,
    icon: <Briefcase size={24} color="#FFFFFF" strokeWidth={2.5} />,
    image: 'https://images.pexels.com/photos/4239146/pexels-photo-4239146.jpeg?auto=compress&cs=tinysrgb&w=400',
    gradient: ['#10B981', '#FA4616'],
  },
  {
    id: 'events',
    title: 'Event Planning',
    subtitle: 'Party & gatherings',
    icon: <Heart size={32} color="#FFFFFF" strokeWidth={2.5} />,
    icon: <Heart size={24} color="#FFFFFF" strokeWidth={2.5} />,
    image: 'https://images.pexels.com/photos/1190298/pexels-photo-1190298.jpeg?auto=compress&cs=tinysrgb&w=400',
    gradient: ['#FFD700', '#FA4616'],
  },
  {
    id: 'custom',
    title: 'Custom Task',
